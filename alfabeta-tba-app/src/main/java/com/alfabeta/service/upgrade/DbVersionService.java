package com.alfabeta.service.upgrade;

import com.alfabeta.model.DbVersion;
import com.alfabeta.repository.DbVersionRepository;
        ...
        Enumeration<URL> resources = getClass().getClassLoader()
              ...
              while (resources.hasMoreElements()) {
                  try {
                    ...
                    if("alfabeta".equals(manifest.getMainAttributes().getValue("Implementation-Title"))){
